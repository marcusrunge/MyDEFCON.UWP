...
{
    public static class UncheckedItemsService
    {
        ...
        public static SolidColorBrush CheckRectangleFill(ItemObservableCollection<CheckListItem> collection, int collectionID, int uncheckedItems, int actualDefconStatus)
        {
            if (collectionID >= actualDefconStatus)
            {
                try
