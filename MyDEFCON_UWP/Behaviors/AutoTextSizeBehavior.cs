...
namespace MyDEFCON_UWP.Behaviors
{
    public class AutoTextSizeBehavior : Behavior<FrameworkElement>
    {
        ...
        {
            base.OnAttached();
            if (AssociatedObject is RadioButton button) button.SizeChanged += AssociatedObject_SizeChanged;
        }
        ...
        private void AssociatedObject_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            if (AssociatedObject is RadioButton button1) length = button1.Content.ToString().Length;
            ...
            if (AssociatedObject is RadioButton button) button.FontSize = fontSize > 0 ? fontSize : 1;
        }
