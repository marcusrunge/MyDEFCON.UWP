...
namespace MyDEFCON_UWP.ViewModels
{
    ...
    public class CheckListPageViewModel : ViewModelBase
    {
        ...
        public async override Task OnNavigatedToAsync(object parameter, NavigationMode mode, IDictionary<string, object> state)
        {
            ...
            Defcon1CheckList = await CheckListManagement.LoadCheckList(1);
            Defcon2CheckList = await CheckListManagement.LoadCheckList(2);
            Defcon3CheckList = await CheckListManagement.LoadCheckList(3);
            Defcon4CheckList = await CheckListManagement.LoadCheckList(4);
            Defcon5CheckList = await CheckListManagement.LoadCheckList(5);
        ...
        private async void Defcon5CheckList_CollectionChanged(object sender, System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            if (!_noUpdate)
            {
                if ((e == null && sender == null) || (sender as ItemObservableCollection<CheckListItem>)[e.NewStartingIndex].Item.Length > 0)
                {
                    ...
                    await CheckListManagement.SaveCheckList(Defcon5CheckList, 5);
                    Defcon5UnCheckedItems = UncheckedItemsService.Count(Defcon5CheckList, 5, _defconStatus);
                    Defcon5CheckRectangleFill = UncheckedItemsService.CheckRectangleFill(Defcon5CheckList, 5, UncheckedItemsService.Count(Defcon5CheckList, 5, _defconStatus), _defconStatus);
                    UpdateTileBadge();
                }
                            ...
                            switch (DefconVisualState)
                            {
                                case VisualState.Defcon1VisualState:
                                    foreach (var item in selectedItems)
                                    {
                                        ...
                                        Defcon1CheckList.Where((c) => c.UnixTimeStampCreated == item.UnixTimeStampCreated).FirstOrDefault().Checked = true;
                                ...
                                case VisualState.Defcon2VisualState:
                                    foreach (var item in selectedItems)
                                    {
                                        ...
                                        Defcon2CheckList.Where((c) => c.UnixTimeStampCreated == item.UnixTimeStampCreated).FirstOrDefault().Checked = true;
                                ...
                                case VisualState.Defcon3VisualState:
                                    foreach (var item in selectedItems)
                                    {
                                        ...
                                        Defcon3CheckList.Where((c) => c.UnixTimeStampCreated == item.UnixTimeStampCreated).FirstOrDefault().Checked = true;
                                ...
                                case VisualState.Defcon4VisualState:
                                    foreach (var item in selectedItems)
                                    {
                                        ...
                                        Defcon4CheckList.Where((c) => c.UnixTimeStampCreated == item.UnixTimeStampCreated).FirstOrDefault().Checked = true;
                                ...
                                case VisualState.Defcon5VisualState:
                                    foreach (var item in selectedItems)
                                    {
                                        ...
                                        Defcon5CheckList.Where((c) => c.UnixTimeStampCreated == item.UnixTimeStampCreated).FirstOrDefault().Checked = true;
